...
- [x] 1.0 Complete project state and configuration module
  ...
  - [x] 1.2 Create project management module
...
- [x] 2.0 Complete project management invoke tasks
...
- [x] 3.0 Complete project-aware generation tasks
  ...
  - [x] 3.2 Create user prompt helper function
